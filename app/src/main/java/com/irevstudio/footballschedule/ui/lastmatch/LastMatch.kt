...
import com.irevstudio.footballschedule.ui.detailevent.MatchDetail
...
class LastMatch : Fragment(), LastMatchView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        adapter = LastMatchAdapter(events){
            startActivity<MatchDetail>(
                    "idEvent" to it.idEvent, "idHomeTeam" to it.idTeamHome, "idAwayTeam" to it.idTeamAway
            )
        }
    ...
    override fun tampilkanLastEvent(data: List<Event>) {
